...
int SolveLinearEquation (const double& b, const double& c) {
    int root_;
    if (b != 0) {
        return root_ = 1;
    } else return  root_ = 0;
...
int main() {
    TestRunner runner;
    runner.RunTest(TestNoRoots, "TestRootCount");
...
//    GetDistinctRealRootCount(2, 6, 2);
